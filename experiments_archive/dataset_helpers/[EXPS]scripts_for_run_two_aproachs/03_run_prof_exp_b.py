...
def main() -> None:
    parser = argparse.ArgumentParser(
        description="Professor Experiment B: stop when scoped appear_count mean reaches baseline mean."
    )
    ...
    print_run_summary("PROF_B", run_dir)

    append_history(
        {
            "experiment": "prof_b_appear_mean_target",
            "run_dir": str(run_dir),
